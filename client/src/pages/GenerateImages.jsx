      ...
      >
        ...
        <div className="my-6 flex items-center gap-2">
          <label className="relative cursor-pointer">
            ...
            <span className="absolute left-1 top-1 w-3 h-3 bg-white rounded-full shadow-sm transition-transform duration-300 peer-checked:translate-x-4"></span>
          </label>
          <p className="text-sm">Make this image public</p>
        </div>

        <button disabled={loading} className="w-full flex justify-center items-center gap-2 rounded-lg text-white text-sm cursor-pointer border px-4 mt-6 py-2 bg-gradient-to-r from-[#00AD25] to-[#4ce77b]">
          {

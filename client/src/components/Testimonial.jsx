...
const Testimonial = () => {
    const dummyTestimonialData = [
        ...
        },
        {
            ...
            name: 'Sarah Chen',
            title: 'Lead Developer, Innovate Labs',
            content: "Intellix.ai's code generation tool is phenomenal. It handles boilerplate code flawlessly, letting my team focus on complex problem-solving. A game-changer for sprint cycles.",
            rating: 5,
        },
        {
            image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=200",
            name: 'Alex Rodriguez',
            title: 'Product Manager, Beta Stream',
            content: "The image generation quality is top-tier. We can create unique, high-resolution visuals for our app store listings in minutes, not days. Excellent toolset!",
            rating: 4,
        },
    ]
